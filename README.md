# On the 15 60%ケース対応版（[オリジナルケース版](https://github.com/Taro-Hayashi/On-the-15/blob/main/README_SA.md)）
- [キット内容](#キット内容)
- [レイアウトを決める](#レイアウトを決める)
- [はんだ付け](#はんだ付け)
- [組み立て](#組み立て)
...
![](img/IMG_6123.jpg)   
1Uと2Uは共存できますが、他の長さの位置を間違えた、もしくは変更する場合はソケットを付けなおしてください。  
